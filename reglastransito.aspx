<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="reglastransito.aspx.cs" Inherits="SistemaWeb.reglastransito" %>
...
<%--    <dx:ASPxMenu runat="server" ID="PageToolbar" ClientInstanceName="pageToolbar"
        ...
        <Items>
            <dx:MenuItem Enabled="false">
                <Template>                    
                        &nbsp;&nbsp;&nbsp; 
                    --<dx:aspxlabel ID="lblTitulo" runat="server" Font-Bold="true" ForeColor="#1279C0" Text="Reglas de Transito" />--
                </Template>
            </dx:MenuItem>
    ...
    <dx:ASPxGridView ID="GridView" runat="server" AutoGenerateColumns="False" 
        DataSourceID="dataSourceReglasTransito" KeyFieldName="ID_ReglaTransito" 
        ...
        SettingsText-Title="Reglas de Transito" 
        ...
        <SettingsPopup>
            <EditForm>
                <SettingsAdaptivity MaxWidth="1200" Mode="Always" VerticalAlign="WindowCenter" />
            </EditForm>
        </SettingsPopup>
        ...
        <Columns>
            <dx:GridViewDataTextColumn FieldName="ID_ReglaTransito" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="1" Caption="ID" Width="100" Visible="false">
                <EditFormSettings Visible="False" />  
            </dx:GridViewDataTextColumn>
            
            <dx:GridViewDataComboBoxColumn FieldName="ID_Sucursal_Origen" ShowInCustomizationForm="True" VisibleIndex="2" Caption="Sucursal Origen">
                <PropertiesComboBox ValueField="ID_Sucursal" TextField="Sucursal" ValueType="System.Int32" DataSourceID="dataSourceSucursales" IncrementalFilteringMode="Contains" DropDownRows="5">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="ID_Sucursal_Destino" ShowInCustomizationForm="True" VisibleIndex="3" Caption="Sucursal Destino">
                <PropertiesComboBox ValueField="ID_Sucursal" TextField="Sucursal" ValueType="System.Int32" DataSourceID="dataSourceSucursales" IncrementalFilteringMode="Contains" DropDownRows="5">
                    <ValidationSettings ErrorDisplayMode="ImageWithText" Display="Dynamic" ErrorTextPosition="Bottom">
                        <RequiredField IsRequired="True" ErrorText="El valor es requerido."></RequiredField>
                    </ValidationSettings>
            ...
            <dx:GridViewDataComboBoxColumn FieldName="ID_Sucursal_Transito" ShowInCustomizationForm="True" VisibleIndex="4" Caption="Sucursal Transito">
                <PropertiesComboBox ValueField="ID_Sucursal" TextField="Sucursal" ValueType="System.Int32" DataSourceID="dataSourceSucursalesTransito" IncrementalFilteringMode="Contains" DropDownRows="5">
                    <ValidationSettings ErrorDisplayMode="ImageWithText" Display="Dynamic" ErrorTextPosition="Bottom">
                        <RequiredField IsRequired="True" ErrorText="El valor es requerido."></RequiredField>
                    </ValidationSettings>
                </PropertiesComboBox>
            ...
            <dx:GridViewDataTextColumn FieldName="Descripcion" ShowInCustomizationForm="True" VisibleIndex="5"></dx:GridViewDataTextColumn>
            <dx:GridViewDataCheckColumn FieldName="Inhabilitado" ShowInCustomizationForm="True" VisibleIndex="6"></dx:GridViewDataCheckColumn>
        </Columns>
    ...
    <asp:EntityDataSource runat="server" ID="dataSourceReglasTransito" DefaultContainerName="DB_GuiasEntities" ConnectionString="name=DB_GuiasEntities" EnableFlattening="False" EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntitySetName="ReglasTransito"></asp:EntityDataSource>
        ...
        <asp:EntityDataSource runat="server" ID="dataSourceSucursalesTransito" DefaultContainerName="DB_GuiasEntities" ConnectionString="name=DB_GuiasEntities" EnableFlattening="False" EnableDelete="False" EnableInsert="False" EnableUpdate="False" EntitySetName="Sucursales" Where="it.EsTransito=true"></asp:EntityDataSource>
    </div>
