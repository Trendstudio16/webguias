<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="generacion.aspx.cs" Inherits="SistemaWeb.generacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function printReportGuia() {
            window.open("ReportGuia.aspx", "PrintingFrame")
        ...
        function printReportEtiqueta() {
            window.open("ReportEtiqueta.aspx", "PrintingFrame")
            var frameElement = document.getElementById("FrameToPrint");
            frameElement.addEventListener("load", function (e) {
                if (frameElement.contentDocument.contentType !== "text/html")
                    frameElement.contentWindow.print();
...
<%--    <dx:ASPxMenu runat="server" ID="PageToolbar" ClientInstanceName="pageToolbar"
    ...
    <dx:ASPxGridView ID="GridView" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <dx:GridViewDataButtonEditColumn VisibleIndex="0" Width="120px" Caption="Imprimir Guia" HeaderStyle-HorizontalAlign="Center">  
                <EditFormSettings Visible="False" />  
                <DataItemTemplate>
                    <div style="width:100%; text-align:center"> 
                        <dx:ASPxButton ID="btnImprimirGuia" runat="server" OnClick="btnImprimirGuia_Click"
                            Text="" AutoPostBack="false" OnInit="btnImprimirGuia_Init" Image-IconID="print_print_16x16office2013" >  
                        </dx:ASPxButton>  
                    </div>
                </DataItemTemplate>  
            </dx:GridViewDataButtonEditColumn>

            <dx:GridViewDataButtonEditColumn VisibleIndex="1" Width="140px" Caption="Imprimir Etiquetas" HeaderStyle-HorizontalAlign="Center">  
                <EditFormSettings Visible="False" />  
                <DataItemTemplate>
                    <div style="width:100%; text-align:center"> 
                        <dx:ASPxButton ID="btnImprimirEtiquetas" runat="server" OnClick="btnImprimirEtiquetas_Click"
                            Text="" AutoPostBack="false" OnInit="btnImprimirEtiquetas_Init" Image-IconID="actions_print_16x16devav" >  
                        </dx:ASPxButton>  
                    </div>
                </DataItemTemplate>  
            </dx:GridViewDataButtonEditColumn>

            <dx:GridViewDataTextColumn FieldName="ID_Guia" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="2" Caption="ID" Width="100" Visible="false">
                <EditFormSettings Visible="False" />  
            </dx:GridViewDataTextColumn>
                                    
            <dx:GridViewDataComboBoxColumn FieldName="ID_Sucursal_Origen" ShowInCustomizationForm="True" VisibleIndex="3" Caption="Suc. Origen">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="ID_Usuario_Origen" ShowInCustomizationForm="True" VisibleIndex="4" Caption="Usuario Origen" Visible="false">
                <EditFormSettings Visible="True" />
            ...
            <dx:GridViewDataComboBoxColumn FieldName="ID_Sucursal_Destino" ShowInCustomizationForm="True" VisibleIndex="5" Caption="Suc. Destino">
                <PropertiesComboBox ValueField="ID_Sucursal" TextField="Sucursal" ValueType="System.Int32" DataSourceID="dataSourceSucursales">
                    <ValidationSettings ErrorDisplayMode="ImageWithText" Display="Dynamic" ErrorTextPosition="Bottom">
                        <RequiredField IsRequired="True" ErrorText="El valor es requerido."></RequiredField>
                    </ValidationSettings>
            ...
            <dx:GridViewDataTextColumn FieldName="Recibe_Destino" ShowInCustomizationForm="True" VisibleIndex="6" Caption="Recibe en Destino" Visible="false">
                <EditFormSettings Visible="true" />
                <PropertiesTextEdit >
                    <ValidationSettings ErrorDisplayMode="ImageWithText" Display="Dynamic" ErrorTextPosition="Bottom">
                        <RequiredField IsRequired="True" ErrorText="El valor es requerido."></RequiredField>
            ...
            <dx:GridViewDataComboBoxColumn FieldName="ID_Sucursal_Transito" ShowInCustomizationForm="True" VisibleIndex="7" Caption="Suc. Transito" Visible="true">
                <EditFormSettings Visible="false" />
                <PropertiesComboBox ValueField="ID_Sucursal" TextField="Sucursal" ValueType="System.Int32" DataSourceID="dataSourceSucursales">
                    <ValidationSettings ErrorDisplayMode="ImageWithText" Display="Dynamic" ErrorTextPosition="Bottom">
                        <RequiredField IsRequired="True" ErrorText="El valor es requerido."></RequiredField>
            ...
            <dx:GridViewDataComboBoxColumn FieldName="ID_TipoEnvio" ShowInCustomizationForm="True" VisibleIndex="8" Caption="Tipo Envio">
            ...
            <dx:GridViewDataSpinEditColumn FieldName="Cantidad_Bultos" ShowInCustomizationForm="True" VisibleIndex="9" Caption="Cant. Bultos">
            ...
            <dx:GridViewDataTextColumn FieldName="Observaciones" ShowInCustomizationForm="True" VisibleIndex="10" Visible="false">
                <EditFormSettings Visible="true" />
            </dx:GridViewDataTextColumn>
            
            <dx:GridViewDataTextColumn FieldName="Nro_Pedido" ShowInCustomizationForm="True" VisibleIndex="11" Caption="Nro. Pedido" Visible="true"></dx:GridViewDataTextColumn>
            
            <dx:GridViewDataDateColumn FieldName="Fecha" ShowInCustomizationForm="True" VisibleIndex="12" Caption="Fecha" Visible="true">
                <EditFormSettings Visible="false" />
            ...
            <dx:GridViewDataTextColumn FieldName="NumeroGuia" ShowInCustomizationForm="True" VisibleIndex="13" Caption="Nº Guia" Visible="true">
                 <EditFormSettings Visible="False" />
             </dx:GridViewDataTextColumn>
                                   
            <dx:GridViewDataComboBoxColumn FieldName="ID_Usuario_Creacion" ShowInCustomizationForm="True" VisibleIndex="14" Caption="Usuario Creación" Visible="false">
                <EditFormSettings Visible="false" />
                <PropertiesComboBox ValueField="ID_Usuario" TextField="Usuario" ValueType="System.Int32" DataSourceID="dataSourceUsuarios">
                    <ValidationSettings ErrorDisplayMode="ImageWithText" Display="Dynamic" ErrorTextPosition="Bottom">
                        <RequiredField IsRequired="True" ErrorText="El valor es requerido."></RequiredField>
            ...
            <dx:GridViewDataComboBoxColumn FieldName="ID_Usuario_Ult_Modif" ShowInCustomizationForm="True" VisibleIndex="15" Caption="Usuario Ult. Modif." Visible="false">
                <EditFormSettings Visible="false" />
                <PropertiesComboBox ValueField="ID_Usuario" TextField="Usuario" ValueType="System.Int32" DataSourceID="dataSourceUsuarios">
                    <ValidationSettings ErrorDisplayMode="ImageWithText" Display="Dynamic" ErrorTextPosition="Bottom">
                        <RequiredField IsRequired="True" ErrorText="El valor es requerido."></RequiredField>
            ...
            <dx:GridViewDataTextColumn FieldName="EstadoGuia" ShowInCustomizationForm="True" VisibleIndex="16" Caption="Estado Guia" Visible="true">
                 <EditFormSettings Visible="False" />
             </dx:GridViewDataTextColumn>

            <dx:GridViewDataDateColumn FieldName="Fecha_Creacion" ShowInCustomizationForm="True" VisibleIndex="17" Caption="Fecha Creacion" Visible="false">
                <EditFormSettings Visible="false" />
                <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy">
                    <ValidationSettings ErrorDisplayMode="ImageWithText" Display="Dynamic" ErrorTextPosition="Bottom">
                        <RequiredField IsRequired="True" ErrorText="El valor es requerido."></RequiredField>
            ...
            <dx:GridViewDataDateColumn FieldName="Fecha_Ult_Modif" ShowInCustomizationForm="True" VisibleIndex="18" Caption="Fecha Ult. Modif" Visible="false">
                <EditFormSettings Visible="false" />
                <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy">
                    <ValidationSettings ErrorDisplayMode="ImageWithText" Display="Dynamic" ErrorTextPosition="Bottom">
                        <RequiredField IsRequired="True" ErrorText="El valor es requerido."></RequiredField>
    ...
    <asp:EntityDataSource runat="server" ID="dataSourceUsuarios" OrderBy="it.Usuario" AutoGenerateWhereClause="true" DefaultContainerName="DB_GuiasEntities" ConnectionString="name=DB_GuiasEntities" EnableFlattening="False" EnableDelete="False" EnableInsert="False" EnableUpdate="False" EntitySetName="Usuarios">
        <WhereParameters>
    ...
    <asp:EntityDataSource runat="server" ID="dataSourceTiposEnvio" OrderBy="it.TipoEnvio" AutoGenerateWhereClause="true" DefaultContainerName="DB_GuiasEntities" ConnectionString="name=DB_GuiasEntities" EnableFlattening="False" EnableDelete="False" EnableInsert="False" EnableUpdate="False" EntitySetName="TiposEnvio">
        <WhereParameters>
            <asp:Parameter DbType="Boolean" DefaultValue="false" Name="Inhabilitado" />
        </WhereParameters> 
    </asp:EntityDataSource>
    <asp:EntityDataSource runat="server" OnInserted="dataSourceGuias_Inserted" OnUpdated="dataSourceGuias_Updated" OnDeleted="dataSourceGuias_Deleted" ID="dataSourceGuias" AutoGenerateWhereClause="false" OrderBy="it.ID_Guia desc" DefaultContainerName="DB_GuiasEntities" ConnectionString="name=DB_GuiasEntities" EnableFlattening="False" EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntitySetName="Guias"></asp:EntityDataSource>
