<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="retiro.aspx.cs" Inherits="SistemaWeb.retiro" %>
            ...
            <dx:GridViewDataButtonEditColumn VisibleIndex="0" Width="160px">  
                <DataItemTemplate>  
                    <div style="width:100%; text-align:center"> 
                        <dx:ASPxButton ID="btnRetirar" runat="server" OnClick="btnRetirar_Click"
                            Text="Retirar Guia" AutoPostBack="false" OnInit="btnRetirar_Init" >  
                        </dx:ASPxButton>  
                    </div>
                </DataItemTemplate>  
