<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="tiposenvio.aspx.cs" Inherits="SistemaWeb.tiposenvio" %>
...
<%--    <dx:ASPxMenu runat="server" ID="PageToolbar" ClientInstanceName="pageToolbar"
        ...
        <Items>
            <dx:MenuItem Enabled="false">
                <Template>                    
                        &nbsp;&nbsp;&nbsp; 
                    --<dx:aspxlabel ID="lblTitulo" runat="server" Font-Bold="true" ForeColor="#1279C0" Text="Tipos de Envio" />--
                </Template>
            </dx:MenuItem>
    ...
    <dx:ASPxGridView ID="GridView" runat="server" AutoGenerateColumns="False" 
        DataSourceID="dataSourceTiposEnvio" KeyFieldName="ID_TipoEnvio" 
        ...
        SettingsText-Title="Tipos de Envio" 
        ...
        <Columns>
            <dx:GridViewDataTextColumn FieldName="ID_TipoEnvio" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="1" Caption="ID" Width="100" Visible="false">
                <EditFormSettings Visible="False" />  
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TipoEnvio" Caption="Tipo de Envio" ShowInCustomizationForm="True" VisibleIndex="2">
                <PropertiesTextEdit>
            ...
            <dx:GridViewDataTextColumn FieldName="Descripcion" ShowInCustomizationForm="True" VisibleIndex="7"></dx:GridViewDataTextColumn>
            <dx:GridViewDataCheckColumn FieldName="Inhabilitado" ShowInCustomizationForm="True" VisibleIndex="8"></dx:GridViewDataCheckColumn>
        </Columns>
    ...
    <asp:EntityDataSource runat="server" ID="dataSourceTiposEnvio" AutoGenerateWhereClause="false" OrderBy="it.TipoEnvio" DefaultContainerName="DB_GuiasEntities" ConnectionString="name=DB_GuiasEntities" EnableFlattening="False" EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntitySetName="TiposEnvio"></asp:EntityDataSource>
